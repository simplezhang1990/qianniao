...
public class UIButton extends LinearLayout {
    ...
    public UIButton(Context context, AttributeSet attrs) {
        ...
        mTitle = a.getString(R.styleable.UIButton_mtitle);
        mSubtitle = a.getString(R.styleable.UIButton_msubtitle);
        ...
        if (mImage > -1) {
            ImageView imageView = ((ImageView) mButtonContainer.findViewById(R.id.image));
